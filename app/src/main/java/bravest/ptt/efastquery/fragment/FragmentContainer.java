...
import bravest.ptt.efastquery.App;
import bravest.ptt.efastquery.R;
import bravest.ptt.efastquery.adapter.CNKFixedPagerAdapter;

/**
 * Created by ts on 2017/8/29.
 */

public class FragmentContainer extends BaseFragment implements ViewPager.OnPageChangeListener {
    @Override
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        if (mView == null) {
            mView = inflater.inflate(R.layout.fragment_container, container, false);
            initViews();
            initValidata();
        }
        return mView;
    ...
    private void initValidata() {
        mColorSelected = App.getInstance().getResources().getColor(R.color.teal_a100);
        mColorUnSelected = App.getInstance().getResources().getColor(R.color.black);
        //添加Tab标签
    ...
    private void addScrollView(String[]titles){
        LayoutInflater mLayoutInflater=LayoutInflater.from(App.getInstance());
